/**
 * Inline stroke icons — no icon dependency, no runtime cost, themable via
 * currentColor. Add new glyphs to PATHS; every consumer stays unchanged.
 */
export type IconName =
  | "dashboard" | "projects" | "calendar" | "partners" | "catalog" | "users" | "settings"
  | "search" | "sun" | "moon" | "monitor" | "panelLeft" | "chevronLeft" | "chevronRight"
  | "chevronDown" | "chevronUp" | "expand" | "collapse"
  | "plus" | "trash" | "copy" | "close" | "check" | "filter"
  | "download" | "file" | "more" | "alert" | "inbox" | "logout" | "edit" | "external"
  | "menu" | "history" | "user";
...
const PATHS: Record<IconName, string> = {
  ...
  partners: "M16 20v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 10a4 4 0 1 0 0-8 4 4 0 0 0 0 8M22 20v-2a4 4 0 0 0-3-3.87M16 2.13a4 4 0 0 1 0 7.75",
  catalog: "M12 2 2 7l10 5 10-5zM2 12l10 5 10-5M2 17l10 5 10-5",
  users: "M16 20v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 10a4 4 0 1 0 0-8 4 4 0 0 0 0 8M19 8v6M22 11h-6",
  ...
  // paired chevrons: pointing apart means "this opens", together means "this
  // closes". Distinct from the single chevrons the sidebar uses to move.
  ...
  history: "M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18M12 7v5l3.5 2",
  user: "M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2M16 7a4 4 0 1 1-8 0 4 4 0 0 1 8 0",
};

export default function Icon({
  name, size = 17, className, strokeWidth = 1.7,
